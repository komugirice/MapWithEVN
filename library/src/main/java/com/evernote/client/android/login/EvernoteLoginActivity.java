...
/**
 * Used if you call {@link EvernoteSession#authenticate(AppCompatActivity)}. You shouldn't need interact
 * with this class directly.
 *
 * @author rwondratschek
 */
public class EvernoteLoginActivity extends AppCompatActivity implements EvernoteLoginTask.LoginTaskCallback {
