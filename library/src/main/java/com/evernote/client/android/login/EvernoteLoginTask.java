...
/*package*/ class EvernoteLoginTask extends Task<Boolean> {
    ...
    private boolean startAuthorization() {
        ...
        Intent intent = mOAuthHelper.startAuthorization((AppCompatActivity)getActivity());
    ...
    private boolean finishAuthorization() {
        return canContinue() && mOAuthHelper.finishAuthorization((AppCompatActivity)getActivity(), mResultCode, mData);
    }
